...
export async function fetchCandidateApi(id: string): Promise<CandidateDetail> {
  const res = await apiFetch(apiUrl(`/api/v1/candidates/${id}`), {
    headers: authHeaders(),
  });
...
export async function createCandidateApi(
  ...
  let res: Response;
  try {
    res = await apiFetch(apiUrl("/api/v1/candidates"), {
      method: "POST",
      headers: authHeaders(),
...
export async function fetchCandidates(
  ...
  const res = await apiFetch(apiUrl(`/api/v1/candidates?${params}`), {
    headers: authHeaders(),
  });
...
export async function updateCandidateSkillsApi(
  ...
  const res = await apiFetch(apiUrl(`/api/v1/candidates/${id}/skills`), {
    method: "PUT",
    headers: authHeaders(),
...
export async function updateCandidateStatusApi(
  ...
  const res = await apiFetch(apiUrl(`/api/v1/candidates/${id}/status`), {
    method: "PATCH",
    headers: authHeaders(),
...
export async function restoreCandidateApi(id: string): Promise<CandidateDetail> {
  const res = await apiFetch(apiUrl(`/api/v1/candidates/${id}/restore`), {
    method: "POST",
    headers: authHeaders(),
  });
...
export async function exportCandidatesApi(
  ...
  const res = await apiFetch(apiUrl(`/api/v1/candidates/export?${params}`), {
    headers: {
